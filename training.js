...
(function () {
  ...
  var MAP_KEY = '50x50';
  var sel = { player: null, enemy: null, ai: false };
  ...
  function renderAll() { renderGrid('my-grid', 'my-detail', 'player'); renderGrid('foe-grid', 'foe-detail', 'enemy'); renderAi(); renderSummary(); }
  renderAll();
